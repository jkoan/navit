...
ATTR(obd2_log)
ATTR(pressure_max_thd_fl)
ATTR(pressure_max_thd_fr)
ATTR(pressure_max_thd_rl)
ATTR(pressure_max_thd_rr)
ATTR(pressure_min_thd_fl)
ATTR(pressure_min_thd_fr)
ATTR(pressure_min_thd_rl)
ATTR(pressure_min_thd_rr)
ATTR(temp_max_thd)
