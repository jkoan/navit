...
static inline void g_mutex_lock_a (GMutex *mutex,
...
static void magazine_cache_push_magazine (guint      ix,
...
static ChunkLink* magazine_cache_pop_magazine (guint  ix,
        gsize *countp) {
...
static inline void thread_memory_magazine2_free (ThreadMemory *tmem,
        guint         ix,
        gpointer      mem) {
    Magazine *mag = &tmem->magazine2[ix];
    ChunkLink *chunk = mem;
...
gpointer g_slice_copy (gsize         mem_size,
...
void g_slice_free1 (gsize    mem_size,
                    gpointer mem_block) {
...
void g_slice_free_chain_with_offset (gsize    mem_size,
                                     gpointer mem_chain,
                                     gsize    next_offset) {
...
static gsize allocator_aligned_page_size (Allocator *allocator,
        gsize      n_bytes) {
