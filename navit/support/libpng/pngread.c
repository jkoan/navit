...
png_structp PNGAPI png_create_read_struct(png_const_charp user_png_ver, png_voidp error_ptr,
...
png_structp PNGAPI png_create_read_struct_2(png_const_charp user_png_ver, png_voidp error_ptr,
...
void PNGAPI png_read_init_2(png_structp png_ptr, png_const_charp user_png_ver,
...
void PNGAPI png_read_init_3(png_structpp ptr_ptr, png_const_charp user_png_ver,
...
void PNGAPI png_read_rows(png_structp png_ptr, png_bytepp row,
...
void /* PRIVATE */ png_read_destroy(png_structp png_ptr, png_infop info_ptr, png_infop end_info_ptr) {
#ifdef PNG_SETJMP_SUPPORTED
    jmp_buf tmp_jmp;
#endif
...
void PNGAPI png_read_png(png_structp png_ptr, png_infop info_ptr,
                         int transforms,
                         voidp params) {
    int row;
