 ...
 */
void /* PRIVATE */ png_reset_crc(png_structp png_ptr) {
...
void PNGAPI png_free_data(png_structp png_ptr, png_infop info_ptr, png_uint_32 mask,
                          int num) {
 ...
 */
void /* PRIVATE */ png_info_destroy(png_structp png_ptr, png_infop info_ptr) {
...
int /* private */ png_check_cHRM_fixed(png_structp png_ptr,
